...
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False # to avoid building up too much unhelpful data in memory when our application is running.
...
def index():
    response = make_response(
        '<h1>Welcome to pet directory!</h1>', 200
    )
    return response
